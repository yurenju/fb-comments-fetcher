...
* [唐少婷]('http://facebook.com/' + users[user].id) (重複 16 次)

新聞：

* 【明星即時拍】為豬哥亮講港味台語　吳慷仁你盡力了
* 【特企】快炒風紮實口感!蔥爆蝦仁麵
* 【特企】教你做創意健康好味「改頭換麵」
* 《花》遭男童壓破　我是馬克在臉書靠腰了
* 【更新】港股結束連7跌　盤中震盪逾1000點
* 作者投奔橘營　洪秀柱撤換競選歌曲
* 「10年前你讓位給我」　現在輪到我報恩了
...
* [Ting Lulu]('http://facebook.com/' + users[user].id) (重複 1 次)
* [Karen Huang]('http://facebook.com/' + users[user].id) (重複 1 次)
* [林潔]('http://facebook.com/' + users[user].id) (重複 1 次)
* [Vincent Lo]('http://facebook.com/' + users[user].id) (重複 1 次)
* [陳堂福]('http://facebook.com/' + users[user].id) (重複 1 次)
* [Jane Pan]('http://facebook.com/' + users[user].id) (重複 1 次)
* [王垣善]('http://facebook.com/' + users[user].id) (重複 1 次)
* [陳瑜瑄]('http://facebook.com/' + users[user].id) (重複 1 次)
* [吳花 花]('http://facebook.com/' + users[user].id) (重複 1 次)
* [Yu Ling Chen]('http://facebook.com/' + users[user].id) (重複 1 次)
* [李多莉]('http://facebook.com/' + users[user].id) (重複 1 次)
